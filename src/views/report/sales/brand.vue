  ...
  <div>
    <my-table v-model="query" :searchForm="searchForm" @change="onChange">
      ...
      >
        ...
        <el-table-column prop="brandName" label="品牌名称" width="250"></el-table-column>
      ...
      <el-row class="table-footer">
        销售总额:
        <span style="color: #f56c6c;">￥{{totalAmt | toThousandFilter}}</span>
      </el-row>
    </my-table>
  </div>
</template>
...
export default {
  ...
  methods: {
    fetchReportData() {
      ...
      return this.$post(`report/sales/brand`, params)
        .then(res => {
